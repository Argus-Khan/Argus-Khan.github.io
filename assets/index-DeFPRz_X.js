(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))d(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const r of t.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&d(r)}).observe(document,{childList:!0,subtree:!0});function m(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function d(e){if(e.ep)return;e.ep=!0;const t=m(e);fetch(e.href,t)}})();document.querySelector("#navB").innerHTML=`
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20">
                <div class="flex items-center">
                    <a href="https://morphykun0vvv0.itch.io/" class="flex-shrink-0 flex items-center z-10">
                        <img class="h-10 p-1 w-auto rounded-full bg-[#cba6f7]" src="/resources/EmbosedHeart_v.png" alt="Logo">
                    </a>
                </div>
                <div class="flex items-center">
              ...
              <div class="hidden md:ml-4 md:flex md:items-center md:space-x-4">
                    ...
                    <div class="flex items-center md:hidden" x-data="{navExpand: false}">
                        <button id="navToggle" type="button" class="z-10 inline-flex items-center justify-center p-2 rounded-full text-[#b4befe] hover:text-[#b4befe] hover:bg-gray-700 shadow-lg shadow-[#cba6f7]/50" x-on:click="navExpand = ! navExpand">
            ...
            <div id="dropdownNav" class="px-5 pt-25 pb-10 space-y-1 absolute top-0 left-0 w-screen border-b-2 border-[#cba6f7] rounded-b-2xl dropdownNav shadow-lg shadow-[#cba6f7]/50 text-center z-5"> 
...
`;document.querySelector("#intro").innerHTML=`
    <div class="text-left nerd-font pt-25 px-10 xl:px-50 sm:px-10 md:px-25 w-screen fixed sm:top-10 md:top-10 lg:top-15 xl:top-60" x-data="{ mesg: false }">
      <h1 class="text-4xl text-[#f5c2e7] ">Heya! I'm <span class="bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-pink-500 animate-wiggle">Argus</span>.</h1>
...
`;const l=a=>new Promise(n=>setTimeout(n,a)),p=" +    +    = 󱅾 Coding...";let o=0,s="",i=!1;async function c(){s=p,i?(document.querySelector("#typewriter").textContent=s.substring(0,o-1),o--,o==0&&(await l(1e3),i=!1)):(document.querySelector("#typewriter").textContent=s.substring(0,o+1),o++,o==s.length&&(await l(3e3),i=!0)),setTimeout(c,30)}c();
